              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text("Today you have 9 tasks", style: RubikFont.w400.copyWith(fontSize: 18.sp, color: Colors.white)),
                  ],
                ),
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 11.w),
                    Text("08.00 AM", style: RubikFont.w400.copyWith(fontSize: 11.sp, color: Color(0xFFC6C6C8))),
                    SizedBox(width: 15.w),
                    Expanded(child: Text("Go jogging with Christin", style: RubikFont.w500.copyWith(fontSize: 14.sp, color: Color(0xFF554E8F)), maxLines: 1, overflow: TextOverflow.ellipsis)),
